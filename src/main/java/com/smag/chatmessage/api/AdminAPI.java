...
public class AdminAPI {
    ...
    private ResponseEntity addUsers(@Valid @RequestBody List<User> users) {
        ...
        if (errorUser.isEmpty())
            return new ResponseEntity(errorUser, HttpStatus.OK);

        else
            return new ResponseEntity(errorUser, HttpStatus.CONFLICT);
    }
    ...
    private @ResponseBody ResponseEntity findUserByParameters(@RequestParam(required = false) String surname,
            @RequestParam(required = false) String name, @RequestParam(required = false) String email,
            @RequestParam(required = false) String phone, @RequestParam(required = false) String profile) {
